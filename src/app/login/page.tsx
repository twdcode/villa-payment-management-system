      ...
      <div className="mx-auto grid min-h-screen max-w-[116rem] overflow-hidden bg-surface md:min-h-[calc(100vh-4.5rem)] md:grid-cols-[minmax(0,1fr)_minmax(26rem,1fr)] md:rounded-lg md:shadow-[0_20px_70px_rgba(43,30,34,0.08)]">
        <section className="order-2 flex min-w-0 items-center px-6 py-10 sm:px-10 md:order-1 md:px-[clamp(3rem,7vw,9rem)] md:py-14">
          <div className="w-full max-w-[34rem]">
            ...
            <form className="mt-10 space-y-6" onSubmit={(event) => { event.preventDefault(); router.push("/dashboard"); }}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input autoComplete="email" id="email" placeholder="Enter your email" required className="h-14 pl-12 text-base" type="email" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input autoComplete="current-password" id="password" placeholder="Enter your password" required className="h-14 pl-12 pr-12 text-base" type={showPassword ? "text" : "password"} />
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
                ...
                <button className="font-semibold text-accent hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" type="button">Forgot password?</button>
              </div>

              <Button className="h-14 w-full font-display text-xl" size="lg" type="submit">Sign in</Button>
            </form>
